...
def seed_master_data():
    ...
    try:
        ...
        # 7) 부품 항목
        parts = [
            {"part_name": "bolt", "part_spec": "M8 x 25mm, 육각머리볼트, 강도등급 8.8, 아연도금"},
            {"part_name": "locatingpin", "part_spec": "Ø6 x 30mm, 다우얼핀, SKD11, 경도 HRC58-62"},
            {"part_name": "nut", "part_spec": "M8, 육각너트, 강도등급 8, 아연도금"},
            {"part_name": "washer", "part_spec": "Ø8.4 x Ø17 x 1.6t, 평와셔, SPHC, 아연도금"},
        ]
        for p in parts:
